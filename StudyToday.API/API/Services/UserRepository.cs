...
namespace API.Services
{
    public class UserRepository : IUserRepository
    {
           ...
           )
        {
            ...
            var returnUserList = new List<UserDto>();
        ...
        public async Task<Guid> CreateAsync(UserForCreationDto creationDto)
        {
            ...
            var newUser = Activator.CreateInstance<UserEntity>();
            ...
            foreach (var roleName in creationDto.RoleNames)
            {
        ...
        public async Task<Guid> UpdateAsync(Guid id, UserForUpdationDto updationDto)
        {
            ...
            foreach (var propertyInfo in updationDto.GetType().GetProperties())
            {
